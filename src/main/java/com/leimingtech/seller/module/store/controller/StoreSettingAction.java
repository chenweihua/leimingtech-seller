...
public class StoreSettingAction {
    ...
    public String edit(@ModelAttribute("storeVo") StoreVo storeVo, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            store.setStoreState(storeVo.getStoreState());
    ...
    public String storeseting(Model model,@RequestParam(required = false, value = "flag", defaultValue = "") String flag){
        //个人信息修改菜单
    	...
    	model.addAttribute("flag", flag);//用来标示审核未通过修改，还是正常的修改店铺信息
