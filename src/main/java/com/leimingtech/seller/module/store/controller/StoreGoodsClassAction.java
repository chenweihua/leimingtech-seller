 ...
 * 商户自分类
 * 
 * 项目名称：leimingtech-seller 类名称：StoreGoodsClassAction 类描述： 创建人：weiyue 创建时间：2014年12月1日
...
public class StoreGoodsClassAction {
	...
	Map<String, String> saveOrUpdate(
		...
		storeGoodsClass.setStcState(stcState);//true 显示 false不显示
		storeGoodsClass.setCheckState(0);//是否审核通过，0审核中，1审核通过，2审核不通过
