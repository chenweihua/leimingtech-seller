...
function getToUrl(id){
	...
	//商品管理
	else if(id=="prosell"){//发布商品
		
		toUrl = "/pro/sell";
		
	}else if(id=="prosale"){//出售中的商品
		
		toUrl = "/pro/sale";
	
	}else if(id=="prostore"){//仓库中的商品
	...
	else if(id=="storeinfo"){//店铺基本信息
		toUrl = "/store/info";
	}else if(id=="storebrand"){//店铺品牌申请
		toUrl = "/storeBrand/index";
	}else if(id=="brandApply"){//店铺品牌申请
        toUrl = "/storeBrand/index";
    }else if(id=="classif"){//店铺分类导航
		toUrl = "/storeGoodsClass/index";
	}else if(id=="shopset"){//店铺设置
		toUrl = "/storeSetting";
