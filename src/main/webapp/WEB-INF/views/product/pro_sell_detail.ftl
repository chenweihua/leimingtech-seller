       ...
       <dl>
        	...
        	<dd>
        		<div class="pic_list">
	                ...
	                <div class="content">
	                	...
	                	<div class="standard">
	                		<div>
	                			<ul style="min-height: 130px;overflow:auto;overflow-x: hidden;" id="photoView01" name="photoView01" class="gbin1-list">
        ...
        <dl>
          ...
          <dd>
            ...
            <p class="hint">店铺分类可以由 "商家中心  -> 商品管理 -> 店铺分类" 中自定义</p>
          </dd>
        </dl>
        <dl>
          <dt>商品发布：</dt>
