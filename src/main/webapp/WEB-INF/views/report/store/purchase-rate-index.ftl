...
<div class="layout">
  ...
  <div class="right-content">
     <div class="path">
      <div>
      <a href="${base}/">商家中心</a> <span>></span> <a href="orderIndex"/>购买力统计</a><span>></span>商品购买数量
	  </div>
    </div>
        <div class="main">
<div class="wrap">
  ...
  <ul class="tab pngFix">
	 <li id="goodsTable" class="active"  ><a  href="javascript:void(0);">商品购买数量</a></li>
	  <!-- <li id="storeTable" class="normal"><a  href="javascript:void(0);"  onClick="changeReportTable('storeTotalCount')">店铺总销量</a></li> -->
  </ul>
    </div>
