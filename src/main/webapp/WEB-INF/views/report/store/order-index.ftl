...
<div class="layout">
	...
	<div class="right-content">
		<div class="path">
			<div>
				<a href="${base}/">商家中心</a> <span></span> <a href="orderIndex" />订单统计</a><span></span>订单数量统计
			</div>
		</div>
		<div class="main">
			<div class="wrap">
				<div class="tabmenu">
					<ul class="tab pngFix">
						<li id="goodsTable" class="active"><a href="javascript:void(0);">订单统计</a></li>
						<li id="goodsTable" class="normal"><a href="${base}/report/knockdownIndex?orderState=40">成交统计</a></li>
					</ul>
				</div>
			...
			<script type="text/javascript">
			    ...
			    function initDataList(){
			        ...
			        $.ajax({
			            async:false,
			            url:"${base}/report/highchartorderlist",//默认加载list 页面
			            data:{div:div},
			            error:function(){
			                layer.msg("通讯失败!" , 1 , 9 );
