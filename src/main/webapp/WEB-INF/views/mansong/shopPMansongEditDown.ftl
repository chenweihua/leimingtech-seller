...
<link href="${base}/res/css/mansong/base.css" rel="stylesheet" type="text/css">
<link href="${base}/res/css/mansong/seller_center.css" rel="stylesheet" type="text/css">
<link href="${base}/res/css/mansong/font-awesome.min.css" rel="stylesheet" />
...
<script type="text/javascript" src="${base}/res/js/mansong/jquery.js"></script>
<script type="text/javascript" src="${base}/res/js/mansong/seller.js"></script>
<script type="text/javascript" src="${base}/res/js/mansong/waypoints.js"></script>
<script type="text/javascript" src="${base}/res/js/mansong/jquery-ui/jquery.ui.js"></script>
<script type="text/javascript" src="${base}/res/js/mansong/jquery.validation.min.js"></script>
<script type="text/javascript" src="${base}/res/js/mansong/common.js"></script>
<script type="text/javascript" src="${base}/res/js/mansong/member.js" charset="utf-8"></script>
<script type="text/javascript" src="${base}/res/js/mansong/dialog.js" id="dialog_js" charset="utf-8"></script>
		...
		<div class="main">
			...
			<div class="wrap">
				<div class="tabmenu">
					<ul class="tab pngFix">
						<li class="active"><a
							href="${sellerServer }/shopPMansong/list">活动列表</a></li>
						<li class="active"><a
							href="#?act=store&amp;op=store_mansongadd">添加活动</a></li>
					</ul>
				</div>
  ...
  <form id="add_form" action="index.php?act=store_promotion_mansong&op=mansong_save" method="post">
    ...
    <dl>
      ...
      <dd>
        ...
        <span class="error-message"></span>
        <p class="hint">开始时间不能为空且不能早于2015-11-26 00:00</p>
      </dd>
    </dl>
    <dl>
      ...
      <input id="end_time" name="end_time" type="text" class="text w130"/><em class="add-on"><i class="icon-calendar"></i></em>
        <span class="error-message"></span>
        <p class="hint">
        结束时间不能为空且不能晚于2016-02-21 17:14        </p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
                    <table class="search-form">
                        <tr>
                            ...
                            <td class="w70 tc">
                                <a href="javascript:void(0);" id="btn_search_goods" class="ncsc-btn"/><i class="icon-search"></i>搜索</a>
                            </td>
                            <td class="w10"></td>
                            <td>
        ...
        <span class="error-message"></span>
        <p class="hint">设置当单笔订单满足金额时（必填选项），减免金额（选填）或赠送的礼品（选填）；留空为不做减免金额或赠送礼品处理。系统最多支持设置三组等级规则。</p>
      </dd>
    </dl>
    <dl>
      <dt>备注：</dt>
...
<script src="${base}/res/js/mansong/common.js"></script>
<script type="text/javascript" src="${base}/res/js/mansong/template.min.js"></script>
<script src="${base}/res/js/mansong/i18n/zh-CN.js"></script>
<script src="${base}/res/js/mansong/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.min.js"></script>
<link rel="stylesheet" type="text/css" href="${base}/res/js/mansong/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.min.css"  />
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
        ...
        rules : {
            ...
            start_time : {
                required : true,
                greaterThanDate : '2015-11-26 00:00'
            },
            end_time : {
                required : true,
        ...
        messages : {
            ...
            start_time : {
                required : '<i class="icon-exclamation-sign"></i>开始时间不能为空且不能早于2015-11-26 00:00',
                greaterThanDate : '<i class="icon-exclamation-sign"></i>开始时间不能为空且不能早于2015-11-26 00:00'
            },
            end_time : {
    ...
    $('#btn_search_goods').on('click', function() {
        var url = "http://localhost/shop/index.php?act=store_promotion_mansong&op=search_goods";
