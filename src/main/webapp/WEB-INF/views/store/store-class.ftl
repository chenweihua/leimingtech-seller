...
<div class="wrap">
  ...
  <table class="ncu-table-style" id="my_category" server="#?act=store&op=goods_class_ajax" >
      ...
      <tr nc_type="table_header">
        <th class="w30"></th>
        <th coltype="editable" column="stc_name" checker="check_required" inputwidth="30%">分类名称</th>
        <th class="w60" coltype="editable" column="stc_sort" checker="check_max">排序</th>
        <th class="w120" coltype="switchable" column="stc_state" checker="" onclass="showclass-ico-btn" offclass="noshowclass-ico-btn">显示</th>
        <th class="w60" coltype="editable" column="stc_checkState" checker="check_max" inputwidth="30px">审核状态</th>
        <th class="w90">操作</th>
      </tr>
      <tr>
					...
					<#list storeGoodsClassListT as storeclass>
						 <#if storeclass.hasChild!=0 && storeclass.stcParentId==0>
						      <tr class="bd-line" nc_type="table_item" idvalue="${storeclass.stcId}" name="ids">
						        ...
						        <td>
						                    <#if storeclass.checkState==0>
						                      	审核中
						                      <#elseif storeclass.checkState==1>
						                      	审核通过
						                      <#else>
						                       	未通过
						                   </#if>
				            ...
				            <#list storeclass.classList as storeclass2>
					              <tr class="bd-line" nc_type="table_item" >
							        ...
							        <td>
							         ...
							         <td>
						                    <#if storeclass2.checkState==0>
						                      	审核中
						                      <#elseif storeclass2.checkState==1>
						                      	审核通过
						                      <#else>
						                       	未通过
						                   </#if>
