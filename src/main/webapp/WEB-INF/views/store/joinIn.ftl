<@p.header title="选择店铺类型"/>
<div class="layout">
    <div class="wrap-shadow">
        <div class="wrap-all">
            <div class="chart">
                <div class="pos_x1 bg_a2" title="请选择店铺分类"></div>
                <div class="pos_x2 bg_b1" title="填写店主和店铺信息"></div>
            ...
            <div class="grade-shop">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="w120"><a href="${base}/joinIn/step2" class="ncu-btn4 w80 ml10">立即开店</a></td>
                    </tr>
                    </tbody>
                    <tfoot>
