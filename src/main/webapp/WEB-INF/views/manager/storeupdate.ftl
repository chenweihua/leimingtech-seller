...
<style>
.submit { font-size: 12px; font-weight: bold; color: #FFF; text-shadow: 0 -1px 0 rgba(0,0,0,0.1); background-color: #49AFCD; display: block; height: 30px; padding: 0 20px 2px 20px; border: 0; cursor: pointer; }
.submit-border:hover { borderd-color: #499249 #499249 #3D7A3D #499249;}
.submit:hover, .submit:hover { text-decoration: none; color: #FFF; background-color: #37839A;}
.submit disabled{ font-size: 12px; font-weight: bold; color: #FFF; text-shadow: 0 -1px 0 rgba(0,0,0,0.1); background-color: #777; display: block; height: 30px; padding: 0 20px 2px 20px; border: 0; cursor: pointer; }
</style>
<div class="layout">
  <#if store.storeState==1>
	  <div class="sidebar">
  ...
  <div class="right-content">
    <div class="path">
      <div>
      <a href="${base}/">商家中心</a> <span>></span><a href="#"/>店铺设置</a><span>></span>店铺设置 
      </div>
    </div>
  <div class="main">
		<div class="wrap">
		  <div class="tabmenu">
		    <ul class="tab pngFix">
		     <li class="active"><a  href="${base}/storeSetting/storeseting">店铺设置</a></li><li class="normal"><a  href="${base}/storeSetting/storeside">幻灯片设置</a></li>
		    </ul>
		  </div>
		  <div class="ncu-form-style">
		    <form method="post"  action="" enctype="multipart/form-data" id="my_store_form">
		      ...
		      <dl>
		        <dt>店铺等级：</dt>
		        <dd>
		          <p>系统默认<a href="#" class="ncu-btn2" target="_blank" title="马上升级店铺等级">马上升级店铺等级</a> </p>
		        </dd>
		      </dl>
		      -->
		      <dl>
		      ...
		      <dl class="bottom">
		        <dt>&nbsp;</dt>
		        <dd style="text-align: center;"><button type="button" id="submitBtn" class="submit">保存</button></dd>
		      </dl>
		    </form>
		  </div>
		</div>
