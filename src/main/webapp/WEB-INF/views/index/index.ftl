...
<div id="home">
  <div class="intro">
    <div class="left">
      <div class="store-pic"><span class="thumb size80"><i></i><img src="${imgServer}${store.storeLogo}"  onload="javascript:DrawImage(this,80,80);" title="${store.storeName}" alt="${store.storeName}" /></a></span><em><a href="${base}/storeSetting/storeseting">更改店标</a></em></div>
      <dl class="basic">
	      ...
	      <#--   <dd class="cert">
	        ...
	        <dd class="credit"> <span> 卖家信用：${evaluateStore.averageCredit!'0'}</span>
	        </dd>
      </dl>
      <dl>
        <dt>店铺名称：</dt>
  ...
  <div class="seller-cont">
    <div class="l">
      <div class="stroe-info container">
        <div class="hd">
          <div class="shop-level"><span>店铺等级：${storeGrade.sgName}</span> <!-- <span>有效期：不限制</span> <span>可传商品：100</span> <span>可传图片：500</span> --> </div>
          <h2>店铺提示</h2>
        </div>
        <div class="content">
          <dl class="focus">
            ...
            <dt>咨询提示：</dt>
            <dd><a href="${base}/consult/index?cur=index">买家的留言 (<strong id="tj_consult"></strong>)</a></dd>
           <!--  <dt>违规提示：</dt>
      ...
      <!-- <div class="predeposit-info container">
        ...
        <div class="content">
          ...
          <div class="hint">
            <h3>您的账户余额：0.00 元</h3>
            <p class="hint">使用平台预存款账户是方便交易流程并可购买兑换金币，参与更多店铺促销增值服务</p>
            ...
            <div class="wrap" style="width: 970px;margin-left: 6px;">
                <div class="open-store">
                    <div style="padding-left: 240px;">
                        ...
                        <dl>
                          <dt style="font-size: 3em;">该店铺正在审核中&nbsp;</a></dt>
                        </dl>
                    <div class="clear"></div>
                    </div>
                </div>
