...
<div class="wrap"> 
  ...
  <div class="tabmenu">
    <ul id="listpj" class="tab">
      <li class="active"><a href="#?act=store_evaluate&op=list#listpj">来自买家的评价</a></li>
      <li><a href="${imgServer}/upload/excelgoodeva.xls">下载评论模板</a></li>
      <li>
      ...
      <!-- <li class="normal"><a href="#?act=store_evaluate&op=list&type=fromseller#listpj">来自卖家的评价</a></li>
...
function initDataList(){
	...
	function ajaxFileUploads(myBlogImage){
	    $.ajaxFileUpload({
	        ...
	        url: '${base}/trade/fileexcelUpload',
