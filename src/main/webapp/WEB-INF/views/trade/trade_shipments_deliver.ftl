  				...
  				<div class="step-title"><em>第一步</em>确认收货信息及交易详情</div>
  					<form name="deliver_form" method="POST" id="deliver_form" action="#?act=deliver&op=send" onsubmit="ajaxpost('deliver_form', '', '', 'onerror');return false;">
            				...
            				<#if daddressList?size gt 0>
            					...
            					<#list daddressList as daddress>
            						...
            						<#else>
            							...
            							<input type="hidden" name="daddressId" id="daddressId" value="">
            						</#if>
            					</#list>
            					<#else>
            						<a href="${base}/transport/shipments_setting" class="fr">
		            					新增发货地址
		            				</a>
    					...
    					<div class="ncm-notes">
    						<i class="lightbulb"></i>
    						您可以通过"发货设置->
    						<a href="${base}/transport/tradelogis" target="_parent" >
    							默认物流公司
    						</a>
